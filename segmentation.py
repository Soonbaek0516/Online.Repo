...
def segment_image(image_path):
    ...
    while True:
        ...
        if key == ord("n"):
            # Confirm skipping without saving
            confirm = input("Do you want to skip without saving? (y/n): ").strip().lower()
            if confirm == "y":
                print("Skipping without saving.")
                break
        elif key == ord("s"):
...
if __name__ == "__main__":
    image_folder = r"C:/Users/cic/Desktop/kimjw/Soonbaek/dataset"
